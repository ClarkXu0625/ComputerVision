...
parser.add_argument('--dataset', default= 'lfw.zip', type=str)#'../../dataset/face/casia/casia.zip', type=str)
...
def train(epoch,args):
    ...
    total = 0
    batch_idx = 0
    ds = ImageDataset(args.dataset,dataset_load,'data/pairsDevTrain.txt',name=args.net+':train',
